            ...
            if (activeTab === 'following') {
              return updatedFeed.map((item) => {
                if (item.content.id === contentId) {
                  ...
                  updatedContent.learnedBy = updatedContent.learnedBy.includes(
                    userId
                  )
          ...
          if (Array.isArray(updatedFeed)) {
            if (activeTab === 'following') {
              return updatedFeed.map((item) => {
                if (item.content.id === contentId) {
                  const updatedContent = { ...item.content };
                  updatedContent.bookmarkedBy =
                    updatedContent.bookmarkedBy.includes(userId)
                      ? updatedContent.bookmarkedBy.filter(
                          (id) => id !== userId
                        )
