          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                color: ' #1e3a8a',
                fontSize: '1rem'
              }}>to start your learning journey</p>
            </div>
                ...
                >
                  <Row>
                    <Form.Group as={Col} md="12" controlId="signInFirstName">
                      <Form.Label style={{ color: " #1e3a8a", fontWeight: '500', marginBottom: '0rem' }}>First Name</Form.Label>
                      <Form.Control
                        type="text"
                        name="firstName"
                  ...
                  <Row>
                    <Form.Group as={Col} md="12" controlId="signInLastName">
                      <Form.Label style={{ color: " #1e3a8a", fontWeight: '500', marginBottom: '0rem' }}>Last Name</Form.Label>
                      <Form.Control
                        type="text"
                        name="lastName"
                  ...
                  <Row>
                    <Form.Group as={Col} md="12" controlId="signInPassword">
                      <Form.Label style={{ color: " #1e3a8a", fontWeight: '500', marginBottom: '0rem' }}>Password</Form.Label>
                      <Form.Control
                        type="password"
                        name="password"
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Join thousands of passionate learners and skilled creators on the SKILLHUB platform. Start sharing your knowledge and discover new skills in coding, cooking, photography, and more.
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.875rem' }}>Skill Tutorials</span>
                </div>
                <div style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.2)',
                  borderRadius: '0.5rem',
                  ...
                  <span style={{ fontSize: '0.875rem' }}>Instructors</span>
                </div>
                <div style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.2)',
                  borderRadius: '0.5rem',
                  ...
                  <span style={{ fontSize: '0.875rem' }}> Skill Categories</span>
                </div>
              </div>
            </div>
          </div>
